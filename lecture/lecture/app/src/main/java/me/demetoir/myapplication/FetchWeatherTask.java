...
import me.demetoir.myapplication.data.WeatherContract.WeatherEntry;

/**
 * Created by yujun on 2017-02-01.
 */
...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor cursor = mContext.getContentResolver().query(
                ...
                new String[]{WeatherContract.LocationEntry._ID},//id
                WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING + " = ?",//locationSetting select
                new String[]{locationSetting},//args
                null
        );
...
//            double cityLongitude = cityJson.getDouble(OWM_LONGITUDE);
            ...
            int inserted = 0;
            if (cVVector.size() > 0) {
                ContentValues[] arrayContentValues = new ContentValues[cVVector.size()];
                cVVector.toArray(arrayContentValues);
